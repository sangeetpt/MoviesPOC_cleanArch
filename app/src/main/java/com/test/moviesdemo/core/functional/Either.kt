...
import com.test.moviesdemo.features.movies.Movie
...
sealed class Either<out L, out R> {
    ...
    data class Right<out R>(val b: R) : Either<Nothing, R>(), () -> Either<Failure, List<Movie>> {
        override fun invoke(): Either<Failure, List<Movie>> {
