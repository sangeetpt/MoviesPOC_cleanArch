...
class MovieActivityTest {
    ...
    @Rule
    @JvmField
    var activityTestRule: ActivityTestRule<MoviesActivity> =
    ...
    fun isViewAvailable() {
        ...
        Espresso.onView(withId(R.id.movieList))
    ...
    fun testRecyclerView() {
        Espresso.onView(withId(R.id.movieList)).perform(ViewActions.swipeUp())
    }
